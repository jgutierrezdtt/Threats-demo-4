...
const HINTS: Record<string, Hint> = {
  futbol: {
    ...
    steps: [
      'En la lista de partidos, los marcados "Solo Socios" (RM-FCB-001, RBE-RMA-004, FCB-AJX-005) están bloqueados — el botón lleva al área de socios.',
      'Sin embargo, el parámetro ?match= de la URL no valida la membresía.',
      'Añade manualmente ?match=RM-FCB-001 a la URL (o cópialo de cualquier partido normal y cambia el ID).',
      'El sistema carga el partido restringido directamente y permite completar la compra sin ser socio.',
    ],
  ...
  seguros: {
    ...
    steps: [
      'Ve al Cotizador, elige cualquier producto y llega al paso de resumen.',
      'Aplica ONLINE10 (−10%), luego VERANO26 (−15%), luego FAMILIA (−20%).',
      'No existe límite en el número de códigos ni validación del descuento total acumulado.',
      'Sigue con FIDELIDAD (−25%), NUEVO50 (−50%) — el precio cae a 0€ o negativo sin ningún control.',
    ],
